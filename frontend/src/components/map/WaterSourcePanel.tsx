    ...
    <div className="space-y-4">
      ...
      <div>
        <div className="text-[10px] text-command-muted uppercase tracking-wider mb-3">
          2 nearest hydrants &middot; 1 nearest lake
        </div>
          ...
          <div className="space-y-2">
            {routes.map((route) => {
              ...
              return (
                <div
                  key={src.id}
                  className="flex items-start gap-3 p-2.5 border border-command-border bg-command-bg"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="font-mono text-[10px] text-command-muted">
                      {src.lat.toFixed(5)}, {src.lon.toFixed(5)}
                    </div>
                    <div className="font-mono text-[10px] text-command-muted">
